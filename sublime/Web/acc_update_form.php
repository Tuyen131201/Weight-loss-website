        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu extended logout">
                    <li><a href="acc_update.php"><i class=" fa fa-suitcase"></i>Cá nhân</a></li>
...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <?php
        ...
        $sql = "select * FROM thanhvien where tv_email = '".$_COOKIE["tv_email"]."'";	
    ...
    <form action="acc_update.php" method="post">
                          ...
                          <div class="mb-3">
                                <label> Email thành viên  </label> <br>
                                <input type="text" name="tv_email" class="form-control" value="<?php echo $row['tv_email'];?>">
                            </div>
                        <div class="mb-3">
                                <label>Họ tên </label> <br>
                                <input type="text" name="tv_hoten" class="form-control" value="<?php echo $row['tv_hoten'];?>">
                            </div>
                           
                            <div class="mb-3">
                                <label>Số điện thoại</label> <br>
                                <input type="text" name="tv_sdt" class="form-control" value="<?php echo $row['tv_sdt'];?>" >
                            </div>
                         
                            <div class="mb-3">
                                <label>Địa chỉ</label> <br>
                                <input type="text" name="tv_diachi" class="form-control" value="<?php echo $row['tv_diachi'];?>" >
                            </div>
