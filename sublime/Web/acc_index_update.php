...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    $sql="SELECT *FROM thanhvien
                        WHERE tv_email= '".$_COOKIE["tv_email"]."'";
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php
                    ...
                    <form method="post" action="acc_update_form.php"> 
                    ...
                    <form method="post" action="doimk_form.php"> 
                                            <input type="submit" name="action" class="btn btn-danger" value="Đổi mât khẩu"/>
