...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <?php
                    $sql = "SELECT *FROM thetrang where tv_email= '".$_COOKIE["tv_email"]."'";
                                ...
                                if ($result->num_rows > 0) {
                                  ...
                                  foreach ($result_all as $row) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <form method="post" action="thetrang_update_form.php"> 
                                            <input type="submit" name="action" class="btn btn-success" value="Update"/>
                                            <input type="hidden" name="thetrang_id" value="<?php echo $row['thetrang_id']; ?>"/>
                                                </form>
                                                  <?php
                                              echo "</td>";
                                            echo "<td>";
                                        ...
                                        <form method="post" action="thetrang_delete.php"> 
                                        ...
                                        <?php
                                            ...
                                            echo "<td>";
                                        ?>
                                        <form method="post" action="thetrang_sua_form.php"> 
