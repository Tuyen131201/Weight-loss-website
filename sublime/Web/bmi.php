...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <form action="bmi_xuli.php" method="post">
                        <div class="mb-3">
                                <label> Mã BMI (Nhập mã bmi của bạn như sau: BMI +  2 số. VD: BMI01) </label> <br>
                                <input type="text" name="bmi_id" class="form-control" placeholder= "" >
                            </div>
                            <div class="mb-3">
                                <label> Mã Thể Trạng (Nhập mã thể trạng của bạn như sau: TT + chữ cái đầu tên bạn + 2 số. VD: TTT01) </label> <br>
                                <input type="text" name="thetrang_id" class="form-control"  placeholder="">
                            </div>
                            <div class="mb-3">
