...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <?php
                    $sql = "SELECT bmi.bmi_id, thetrang.height, thetrang.weight, thetrang.ngay, thetrang.tv_email, bmi.chiso FROM thetrang , bmi  where thetrang.thetrang_id=bmi.thetrang_id and  thetrang.tv_email= '".$_COOKIE["tv_email"]."'";
                                  ...
                                  foreach ($result_all as $row) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <?php
                                            ...
                                            echo "<td>";
                                        ?>
                                        <form method="post" action="bmi_delete.php"> 
