...
<?php
                    $sql="SELECT 
                          FROM giasu, chuyennganh, trinhdo
                          WHERE giasu.manganh = chuyennganh.manganh
                                AND giasu.trinhdoID = trinhdo.trinhdoID";
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th data-breakpoints="xs sm md" data-title="DOB">Ngày cập nhật</th>
            <th>Thêm</th>
            <th>Sửa</th>
            <th>Xóa</th>
          </tr>
